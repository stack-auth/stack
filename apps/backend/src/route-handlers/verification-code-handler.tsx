...
//   detailsResponse: DetailsResponse extends SmartResponse ? yup.Schema<DetailsResponse> : undefined,
//   send: (
...
//   details?(project: ProjectsCrud["Admin"]["Read"], method: Method, data: Data, body: RequestBody, user: UserRequired extends true ? UsersCrud["Admin"]["Read"] : undefined): Promise<DetailsResponse>,
