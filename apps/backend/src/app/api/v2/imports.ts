...
import { POST as iInternalSendTestEmailPost } from '../../api/v1/internal/send-test-email/route';
...
import { GET as iInternalMetricsGet } from '../../api/v1/internal/metrics/route';
...
export const endpoints = {
  ...
  '/internal/metrics': { GET: iInternalMetricsGet },
  '/internal/api-keys': {
