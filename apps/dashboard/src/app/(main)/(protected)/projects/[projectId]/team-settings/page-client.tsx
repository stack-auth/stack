...
function CreateDialog(props: { trigger: React.ReactNode; type: "creator" | "member" }) {
    ...
    <PageLayout title="Team Settings">
      <SettingCard title="Client-side Team Creation">
        ...
        <Typography variant="secondary" type="footnote">
          When enabled, users are allowed to create teams from the client-side. If disabled, teams can only be created on the
          dashboard/server.
        </Typography>
      </SettingCard>
      ...
      <SettingCard title="Automatic Team Creation">
        ...
        />
        <Typography variant="secondary" type="footnote">
          When enabled, a personal team will be created for each user when they sign up. This will not automatically create teams for
          existing users.
        </Typography>
      </SettingCard>
      ...
      ).map(({ type, title, description, key }) => (
        <SettingCard
          key={key}
          title={title}
          description={description}
          actions={<CreateDialog trigger={<Button variant="secondary">Edit</Button>} type={type} />}
        >
