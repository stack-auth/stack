...
export const projectFormSchema = yup.object({
  ...
  signInMethods: yup.array(yup.string().oneOf(["google", "github", "microsoft", "facebook", "credential", "magicLink", "discord", "gitlab", "linkedin", "hubspot", "salesforce"]).required()).required(),
});
