...
export default function Home() {
  return (
    <main>
      ...
      <p>
        This is a demo of Stack&apos;s partial prerendering capabilities. The text you are reading here is statically prerendered, while
        user information below is fetched on a dynamic server component.
      </p>

      <p>For the demo, there is an artificial two second delay for network requests. Reload the page to see it again.</p>
