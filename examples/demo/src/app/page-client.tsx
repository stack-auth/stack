  ...
  return (
    <div className="flex h-full w-full flex-col items-center justify-center gap-10">
      {user ? (
        <div className="flex flex-col items-center justify-center gap-5">
          <Typography type="h3">
            Logged in as: <span className="font-bold">{user.primaryEmail}</span>
          </Typography>
          <Typography>Click on your user&apos;s image at the top right to see your account settings.</Typography>
          <Typography>
            Like what you see? <Link href="https://app.stack-auth.com">Create your own project</Link> on our dashboard.
          </Typography>
