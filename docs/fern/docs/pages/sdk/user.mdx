...
- `data` (object): The data for the team to create.
  - `displayName` (string): The display name for the team.
  - `profileImageUrl` (string | null): The URL of the team's profile image (base64 image allowed, crop and compress before passing it in), or null to remove.
