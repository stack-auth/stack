...
This is the same as the `inviteUser` method on the `Team` object, except that it requires a `callbackUrl` parameter.
  ...
  <ParamField path="options" type="object" required>
    <div className="indented">
      ...
      <ParamField path="callbackUrl" type="string" required>
        The callback URL to redirect to after the user signs up. This is normally in the format of `https://your-app-url.com/handler/team-invitation`.
      </ParamField>
    </div>
  </ParamField>
</div>
...
await team.inviteUser({
  email: 'user@example.com',
  callbackUrl: 'https://your-app-url.com/handler/team-invitation',
});
```
