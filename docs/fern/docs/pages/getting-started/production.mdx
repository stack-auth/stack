...
1. **Create an OAuth App**: On the provider's website, create an OAuth app and set the callback URL to the corresponding Stack callback URL. Copy the client ID and client secret.
   <Tabs>
     ...
     <Tab title="Facebook">
       ...
       Callback URL: `https://api.stack-auth.com/api/v1/auth/oauth/callback/facebook`
     </Tab>
     <Tab title="Microsoft">
     ...
     <Tab title="Spotify">
       ...
       Callback URL: `https://api.stack-auth.com/api/v1/auth/oauth/callback/spotify`
     </Tab>
     <Tab title="Discord">
       [Discord OAuth Setup Guide](https://discord.com/developers/docs/topics/oauth2)
       Callback URL: `https://api.stack-auth.com/api/v1/auth/oauth/callback/discord`
     </Tab>
     <Tab title="Gitlab">
       [Gitlab OAuth Setup Guide](https://docs.gitlab.com/ee/integration/oauth_provider.html)
       Callback URL: `https://api.stack-auth.com/api/v1/auth/oauth/callback/gitlab`
     </Tab>
   </Tabs>
