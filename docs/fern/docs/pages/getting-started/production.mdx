...
1. **Create an OAuth App**: On the provider's website, create an OAuth app and set the callback URL to the corresponding Stack callback URL. Copy the client ID and client secret.
   <Tabs>
     ...
     <Tab title="Zoom">
       [Zoom OAuth Setup Guide](https://support.atlassian.com/bitbucket-cloud/docs/use-oauth-on-bitbucket-cloud/)
       Callback URL:
       `https://api.stack-auth.com/api/v1/auth/oauth/callback/zoom`
     </Tab>
     <Tab title="Dropbox">
       [Dropbox OAuth Setup Guide](https://support.atlassian.com/bitbucket-cloud/docs/use-oauth-on-bitbucket-cloud/)
       Callback URL:
       `https://api.stack-auth.com/api/v1/auth/oauth/callback/dropbox`
     </Tab>
     <Tab title="Coinbase">
       [Coinbase OAuth Setup Guide](https://support.atlassian.com/bitbucket-cloud/docs/use-oauth-on-bitbucket-cloud/)
       Callback URL:
