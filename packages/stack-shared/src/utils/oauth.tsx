export const standardProviders = ["google", "github", "facebook", "microsoft", "spotify", "discord", "gitlab", "linkedin", "hubspot"] as const;
...
export const allProviders = ["google", "github", "facebook", "microsoft", "spotify", "discord", "gitlab", "linkedin", "hubspot"] as const;
