export const standardProviders = ["google", "github", "facebook", "microsoft", "spotify", "discord", "gitlab", "linkedin"] as const;
...
export const allProviders = ["google", "github", "facebook", "microsoft", "spotify", "discord", "gitlab", "linkedin"] as const;
