export const standardProviders = ["google", "github", "facebook", "microsoft", "spotify", "discord", "gitlab", "linkedin", "hubspot", "salesforce", "bitbucket", "zoom", "dropbox", "coinbase"] as const;
...
export const allProviders = ["google", "github", "facebook", "microsoft", "spotify", "discord", "gitlab", "linkedin", "hubspot", "salesforce", "bitbucket", "zoom", "dropbox", "coinbase"] as const;
