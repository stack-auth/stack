...
export const userPasswordMutationSchema = yupString().meta({ openapiField: { description: 'Sets the user's password. Doing so revokes all current sessions.', exampleValue: 'my-new-password' } });
export const userTotpSecretMutationSchema = base64Schema.meta({ openapiField: { description: 'Enables 2FA and sets a TOTP secret for the user. Set to null to disable 2FA.', exampleValue: 'dG90cC1zZWNyZXQ=' } });
