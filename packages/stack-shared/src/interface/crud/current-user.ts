...
const clientUpdateSchema = usersCrudServerUpdateSchema
  .pick(["display_name", "profile_image_url", "client_metadata", "selected_team_id", "totp_secret_base64"])
  .required();
...
const clientReadSchema = usersCrudServerReadSchema
  ...
  .nullable()
  .defined(); // TODO: next-release: make required
