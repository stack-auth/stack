...
const Button = React.forwardRef<HTMLButtonElement, ButtonProps>(({ onClick, loading: loadingProp, children, ...props }, ref) => {
  ...
  return (
    <OriginalButton {...props} ref={ref} disabled={props.disabled || loading} onClick={(e) => runAsynchronouslyWithAlert(handleClick(e))}>
