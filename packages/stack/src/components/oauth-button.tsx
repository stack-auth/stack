...
function TwitterIcon({ iconSize } : { iconSize: number} ) {
  return (
    <svg aria-label="Twitter" viewBox="0 0 1200 1227" width={iconSize} height={iconSize} xmlns="http://www.w3.org/2000/svg"
    >
  ...
  switch (provider) {
    ...
    case 'twitter': {
      style = {
        ...
        textColor: "#fff",
        name: "Twitter",
        icon: <TwitterIcon iconSize={iconSize} />,
      };
      break;
    }
    case 'slack': {
