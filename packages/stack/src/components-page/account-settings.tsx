...
function usePasskeySection() {
  ...
  return (
    <>
      <Section title={t("Passkey")} description={has_passkey ? t("Passkey registered") : t("Register a passkey")}>
        <div className='flex md:justify-end'>
          {!hasValidEmail && (
          ...
          {hasValidEmail && has_passkey && isLastAuth && (
          ...
          {hasValidEmail && has_passkey && !isLastAuth && !showConfirmationModal && (
            <Button
              variant='secondary'
